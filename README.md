...
[Link](https://marketplace.visualstudio.com/items?itemName=redlin.remove-tabs-on-save)

### selecta

Used for selecting lines that matches a regex. Line starts with, ends with or contains.

[Link](https://marketplace.visualstudio.com/items?itemName=mrvautin.selecta)
...
[Link](https://marketplace.visualstudio.com/items?itemName=datasert.vscode-texty)
